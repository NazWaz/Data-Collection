...
class Scraper():
    ...
    def get_movie_genre(self):
        self.get_g1()
        g2 = self.g1.find_element(By.XPATH, "a[1]").text
        g3 = self.g1.find_element(By.XPATH, "a[2]").text
        g4 = self.g1.find_element(By.XPATH, "a[3]").text
        g5 = [g2, g3, g4]
        g6 = "/".join(g5)
...
#%%
scraper.get_d1()
print(scraper.d1.text)
#%%
scraper.get_g1()
print(scraper.g1.text)
#%%
scraper.get_movie_genre()
#%%
